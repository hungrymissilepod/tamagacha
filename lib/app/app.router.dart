...
import 'package:flutter_app_template/ui/views/saved_pets/saved_pets_view.dart'
    as _i7;
import 'package:flutter_app_template/ui/views/scan/scan_view.dart' as _i6;
...
class Routes {
  ...
  static const savedPetsView = '/saved-pets-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.savedPetsView,
      page: _i7.SavedPetsView,
    ),
    _i1.RouteDef(
      Routes.settingsView,
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i6.ScanView: (data) {
      return _i9.MaterialPageRoute<dynamic>(
        builder: (context) => const _i6.ScanView(),
        settings: data,
      );
    },
    _i7.SavedPetsView: (data) {
      return _i9.MaterialPageRoute<dynamic>(
        builder: (context) => const _i7.SavedPetsView(),
        settings: data,
      );
    },
...
extension NavigatorStateExtension on _i10.NavigationService {
  ...
  Future<dynamic> navigateToSavedPetsView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.savedPetsView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithSavedPetsView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.savedPetsView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
